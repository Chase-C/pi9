...
export function defineSubagentTool(deps: SubagentToolDeps) {
  ...
  return defineTool<typeof SubagentParams, SubagentToolDetails>({
    ...
    description: [
      ...
      "Each spawn or resume starts a generation; status and joined describe the latest.",
      "Actions:",
      ...
      "  resume(resumes): Start a subagent's next generation after joining its latest result.",
